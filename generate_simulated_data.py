...
np.savetxt("output/source_x.tsv", source_x, delimiter="\t", fmt='%.4f')
np.savetxt("output/source_y.tsv", source_y, fmt='%i')
...
np.savetxt("output/target_x.tsv", target_x, delimiter="\t", fmt='%.4f')
np.savetxt("output/target_y.tsv", target_y, fmt='%i')
